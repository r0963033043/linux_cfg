...
alias github-git-clone='git clone --config user.name="RubyLai" --config user.email=r0963033043@gmail.com $@'
alias set-github-git-ssh='
  export GIT_SSH_COMMAND="ssh -i ~/.ssh/id_rsa_ux334flc";
  export PS1="${PS1}GITPUB ==> "'
